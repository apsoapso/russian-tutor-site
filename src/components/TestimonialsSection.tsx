...
const TestimonialsSection: React.FC = () => {
  ...
  const testimonials: Testimonial[] = [
    {
      content:
        "Благодаря занятиям я смогла повысить свой балл ЕГЭ по русскому языку с 65 до 92! Преподаватель объясняет материал очень понятно и всегда отвечает на все вопросы. Я очень благодарна за профессионализм и индивидуальный подход.",
      author: "Анна К.",
    ...
    {
      content:
        "Мой сын никогда не любил русский язык, но после занятий со Стезей Познания его отношение кардинально изменилось. Он не только улучшил оценки в школе, но и стал интересоваться литературой. Для нас это настоящее чудо!",
      author: "Ольга М.",
    ...
    {
      content:
        "Подготовка к ОГЭ оказалась гораздо интереснее, чем я ожидала. Каждое занятие было насыщенным и увлекательным. Результат — 5 по русскому языку и уверенность в своих знаниях. Теперь готовлюсь к ЕГЭ только с этим преподавателем!",
      author: "Дмитрий С.",
    ...
    {
      content:
        "Я обратилась за помощью в подготовке к творческому конкурсу в театральный вуз. Работа над сочинениями, анализом текстов и выразительностью речи дала отличные результаты — я поступила! Спасибо за профессионализм и вдохновение.",
      author: "Екатерина В.",
